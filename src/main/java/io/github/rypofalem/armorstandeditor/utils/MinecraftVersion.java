...
public class MinecraftVersion {
    ...
    public static final VersionUtil MINECRAFT_26_2 = VersionUtil.fromString("26.2");
    public static final VersionUtil MINECRAFT_FUTURE = VersionUtil.fromString("26.3");
